...
const Header = (props: Props) => {
  return (
    <div className='py-4 bg-gray-100  border-b border-slate-900/10 lg:px-8 dark:border-slate-300/10 mx-4 lg:mx-0'>
      <div className='relative flex items-center'>
        <a className='mr-3 flex-none w-[2.0625rem] overflow-hidden md:w-auto' href='/'>
          <span className='sr-only'>Diagno AI Home Page</span>
          <Image
        ...
        <div className='relative hidden lg:flex items-center ml-auto'>
          ...
          <div className='flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800'>
            <label className='sr-only' id='headlessui-label-:R1lkcr6:' data-headlessui-state=''>
              Theme
            </label>
            <button
              type='button'

      ...
      <div className='flex-auto'>
        ...
        <div className='mb-6 text-sm leading-6 text-slate-600 space-y-4 dark:text-slate-400'>
          <p>
            ...
            kiritish imkonini beradi. Sun'iy intellekt ushbu ma'lumotlarni tahlil qilib, ehtimoliy
            tashxis va davolash bo'yicha tavsiyalarni taklif etadi. Barcha jarayon tezkor va aniq
            natijalarga asoslanadi.
          </p>
          <p>
            Diagno AI tomonidan taqdim etilgan tashxis va tavsiyalar sog'liqni saqlash bo'yicha
            dastlabki qadamlar uchun mo'ljallangan. Foydalanuvchilar tavsiyalar asosida shifokor
            bilan maslahatlashishi yoki kerakli choralarni ko'rishi mumkin. Tizim
            foydalanuvchilarning ma'lumotlarini maxfiy saqlaydi.
          </p>
        </div>
        <a

  ...
  return (
    <>
      ...
      >
        <div
          className={
            'absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,hsl(186, 70%, 35%, 0.5)_15%,hsl(186, 30%, 10%, 0.5)_78%,transparent)]'
          }
        />
        {/* Planet Logic */}
        <div
          className={
            'absolute size-64 md:size-96 bg-green-500 rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_18.3%,#ffffff,#4dd0e1_37.7%,#0a3d40)] shadow-[-20px_-20px_50px_#b2ebf2,-20px_-20px_80px_#e0f7fa,0_0_50px_#4dd0e1]'
          }
        />

            ...
            >
              {[...testimonials, ...testimonials].map((testimonial, index) => (
                <div
                  key={index}
                  className={
                    'border border-muted p-6 md:p-10 rounded-xl bg-[linear-gradient(to_bottom_left,#1e8a8a4d,#0a3d40)] max-w-xs md:max-w-md flex-none'
                  }
                >
                  ...
                  <div className={'flex items-center gap-3 mt-5'}>
                    <div
                      className={
                        "relative after:content-[''] after:absolute after:inset-0 after:bg-[rgb(140,69,244)] after:mix-blend-soft-light after:rounded-lg before:content-[''] before:absolute before:inset-0 before:border before:border-white/30 before:z-10 before:rounded-lg"
                      }
                    >
                      <Image

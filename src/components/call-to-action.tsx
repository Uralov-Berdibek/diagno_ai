      ...
      <section className={'py-20 md:py-24'} ref={sectionRef}>
        <div className={'container'}>
          ...
          >
            <div
              className={
                'absolute inset-0 bg-[#1e8a8a] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_50%_35%,black,transparent)] group-hover:opacity-0 transition duration-700'
              }
              style={{ backgroundImage: `url(${BackgroundGrid.src})` }}
            />
            <motion.div
              className={
                'absolute inset-0 bg-[#1e8a8a] bg-blend-overlay opacity-0 group-hover:opacity-100 transition duration-700'
              }
